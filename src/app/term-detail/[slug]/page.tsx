...
import { ArrowLeft, Clock, Tag, BookOpen, Users, AlertTriangle, History, Globe, Heart, TrendingUp } from 'lucide-react'
...
export async function generateMetadata({ params }: TermDetailPageProps): Promise<Metadata> {
  ...
  return {
    title: `${term.term} - Detailed Analysis | Racial Discrimination Terms`,
    description: `Comprehensive analysis of "${term.term}": historical background, usage context, social impact, and educational insights.`,
    keywords: [...term.tags, 'racial discrimination', 'education', 'historical analysis', 'social impact'],
    openGraph: {
      title: `${term.term} - Detailed Analysis`,
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                {/* 分类信息 */}
                <div className="card">
                  <h3 className="text-lg font-semibold text-neutral-900 mb-3">Classification</h3>
                  <div className="space-y-3">
                    ...
                    <div>
                      <span className="text-sm text-neutral-600">Usage Contexts:</span>
                      <div className="mt-1 flex flex-wrap gap-1">
                        {term.usageContext.map((context) => (
                          <span
                            key={context}
                    ...
                    <div>
                      <span className="text-sm text-neutral-600">Historical Period:</span>
                      <div className="mt-1">
